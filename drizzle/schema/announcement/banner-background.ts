...
export const bannerBackground = sqliteTable('banner_background', {
  ...
  index('background_announcement_idx').on(table.announcementId)
]);
...
export const SelectBannerBackgroundSchema = createSelectSchema(bannerBackground);
export const InsertBannerBackgroundSchema = createInsertSchema(bannerBackground);
export const UpdateBannerBackgroundSchema = createUpdateSchema(bannerBackground,{
